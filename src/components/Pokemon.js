...
export default function Pokemon({ pokemonInfo }) {
    ...
    return (
        <>
            <img className="Pokemon-image" src={require(`../assets/svgPokemon/${pokemonInfo.id}.svg`)} onClick={toggleModal} alt={pokemonInfo.name} />
            ...
            >
                <img className="Pokemon-modalImage" src={require(`../assets/svgPokemon/${pokemonInfo.id}.svg`)} alt={pokemonInfo.name} />
